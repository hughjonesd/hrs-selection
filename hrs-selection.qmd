...
# This ugly code subsets the data by ethnicity then counts all observations
...
# TE if grandkids but no kids div_gkid is infinite. Replacing with NA
...
correct_scores        <- readxl::read_excel("PGI_Heritabilities.xlsx", na = "NA", 
                                            range="B1:U53")
...
# Loop for for calculating results with SNP heritabilities
...
# Loop for for calculating results with twin heritabilities
map_df(1:nrow(correct_scores), function(i) {
...
corrected_effects <- merge(corrected_effects, correct_scores, 
                           by.x="trait", by.y="Abr",prefix=c("",".y"))
...
# Cleaning and saving corrected effects so people can have the exact figures
  ...
  corrected_effects <- corrected_effects[, c("trait", "beta", "SE", "Heritability",
                                            "chip_h2", "twin_h2", "R2", 
                                            "TwinH2_Source", "PoldermanICF_ICD10_subchapter",
                                            "Category")]
