...
abstract: |
  ...
  natural selection: among both black and white respondents,
  ...
  were able to examine selection across three generations, finding the 
  results consistent over time. We also estimate effect sizes 
  corrected for noise in the polygenic scores, finding selection
  for some health traits to be similar in magnitude to cognitive traits. 
date: "January 2024"
format: 
  pdf:
    keep-tex: true
