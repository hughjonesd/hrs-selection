...
<!--# TE not an expert here, but I think it should say y_resid here. I've residualised PGS but not rlrs, because it would complicate the interpetation of our beta under the Price equation. I think we should just remove this paragraph. We can explain our approach by saying the residualisation get's us closer to an unbiased PGS and cite others who have done the same thing.-->*y
\~ PGIs_resid*. We control rather than residualizing because this gives
the correct standard errors[^1], which might matter with our relatively
low N.
...
To simplify interpretation, we've decided to residualise and then
standardize the PGIs on the principal components, instead of control for
them.
...
manuscript this was wrongly referred to as a correlation but thus has
...
covariance between the polygenic scores and RLRS.
...
likely to be of greater importance for phenotypic trends then genetic
change.
...
TE TODO: Write a paragraph on biol. selection. (Not sure what is meant
here?)
