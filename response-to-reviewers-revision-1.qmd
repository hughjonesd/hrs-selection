...
efforts. One effect is just that we have more
polygenic scores to analyse. The original results are not much changed,
which is encouraging. Another is that we look in
more detail at two extra generations, using children and grandparents of
the respondents. We've given the paper a title which reflects that. Lastly,
we have more careful and accurate estimates of effect sizes of "true" and/or
